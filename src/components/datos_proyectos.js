export const datosProyecto = [
    ...
    },
    {
        ...
        description: "This is the second project of the Boootcamp ADA, but the first group-assignment. With this project we learnt how to work on a collaborative project using GitHub, how to use external libraries and to make dinamical web pages manipulating the DOM with JS.",
        technologies: "HTML5, CSS3, JS",
